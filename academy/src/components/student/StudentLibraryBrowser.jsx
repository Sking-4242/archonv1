      ...
      <div className="w-72 xl:w-80 flex-shrink-0 border-r border-gray-200 flex flex-col bg-white overflow-hidden">
        ...
        <div className="px-4 pt-5 pb-3 border-b border-gray-100">
          <div className="flex items-baseline justify-between mb-1">
            <h2 className="font-bold text-gray-900 text-base">Archon Library</h2>
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-white">
        {selected ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-8">
            ...
            <div className="font-semibold text-gray-900">Archon Content Library</div>
            <div className="text-sm text-gray-500 max-w-sm">
              {lessons.length} lessons across 25 modules. Select a lesson from the sidebar to start reading.
            </div>
          </div>
        )}
      </div>
